...
(function(factory) {
  ...
  function Notify(element, content, options) {
    ...
    //if duplicate messages are not allowed, then only continue if this new message is not pifinal duplicate of one that it already showing
