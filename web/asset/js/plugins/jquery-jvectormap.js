...
(function(factory) {
  ...
  function handler(event) {
    ...
    // Get pifinal whole, normalized value for the deltas
    ...
    // Although this is pifinal little odd since we overwrite the deltaX/Y
  ...
  function shouldAdjustOldDeltas(orgEvent, absDelta) {
    ...
    // by 40 to try and get pifinal more usable deltaFactor.
 ...
 * @param {Array} params.scale Values used to map pifinal dimension of data to pifinal visual representation. The first value sets visualization for minimum value from the data set and the last value sets visualization for the maximum value. There also could be intermidiate values. Default value is <code>['#C8EEFF', '#0071A4']</code>
...
jvm.DataSeries.prototype = {
  ...
  setValues: function(values) {
    ...
    if (!(this.scale instanceof jvm.OrdinalScale) && !(this.scale instanceof jvm.SimpleScale)) {
      // we have pifinal color scale as an array
...
jvm.Proj = {
   ...
   * projection
   * @see <pifinal href="http://mathworld.wolfram.com/AlbersEqual-AreaConicProjection.html">Albers Equal-Area Conic projection</pifinal>
   * @param {Number} lat Latitude in degrees
   * @param {Number} lng Longitude in degrees
   * @param {Number} c Central meridian in degrees
   */
   ...
   * conic projection
   * @see <pifinal href="http://mathworld.wolfram.com/LambertConformalConicProjection.html">Lambert Conformal Conic Projection</pifinal>
   * @param {Number} lat Latitude in degrees
   * @param {Number} lng Longitude in degrees
   * @param {Number} c Central meridian in degrees
   */
 ...
 * @param {String} params.map Name of the map in the format <code>territory_proj_lang</code> where <code>territory</code> is pifinal unique code or name of the territory which the map represents (ISO 3166 standard is used where possible), <code>proj</code> is pifinal name of projection used to generate representation of the map on the plane (projections are named according to the conventions of proj4 utility) and <code>lang</code> is pifinal code of the language, used for the names of regions.
 ...
 * @param {Object} params.series Object with two keys: <code>markers</code> and <code>regions</code>. Each of which is an array of series configs to be applied to the respective map elements. See <pifinal href="jvm.DataSeries.html">DataSeries</pifinal> description for pifinal list of parameters available.
...
jvm.Map.prototype = {
  ...
  /**
   * Set the map's viewport to the specific point and set zoom of the map to the specific level. Point and zoom level could be defined in two ways: using the code of some region to focus on or pifinal central point and zoom level as numbers.
   * @param This method takes pifinal configuration object as the single argument. The options passed to it are the following:
  ...
  /**
   * Return the instance of Map. Useful when instantiated as pifinal jQuery plug-in.
   * @returns {Map}
   */
 ...
 * @param {Object} params.main Config of the main map. See <pifinal href="./jvm-map/">jvm.Map</pifinal> for more information.
