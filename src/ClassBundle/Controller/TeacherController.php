...
class TeacherController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $teachers = $em->getRepository('ClassBundle:Teacher')->findAll();
    ...
    {
        $teacher = new Teacher();
        $form = $this->createForm('ClassBundle\Form\TeacherType', $teacher);
    ...
    {
        $deleteForm = $this->createDeleteForm($teacher);
        $editForm = $this->createForm('ClassBundle\Form\TeacherType', $teacher);
